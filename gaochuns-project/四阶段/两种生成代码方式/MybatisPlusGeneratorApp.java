...
public class MybatisPlusGeneratorApp {
    ...
    private static final String database = "db_order";
    ...
    private static final String parentPackage = "com.woniu"; // 父包名。如果为空，将下面子包名必须写全部，否则就只需写子包名
    private static final String entityIn = "entity";
    private static final String mapperIn = "mapper";
    private static final String xmlIn = "mapper";
    private static final String serviceIn = "service";
    private static final String controllerIn = "controller";

    /* 要操作的表名 */
    private static final String tableNames = "order"; // 多个表名用逗号隔开。不要有空格。
    ...
    private static GlobalConfig globalConfig() {
        ...
        if (Objects.equals(moduleName, null) || Objects.equals(moduleName.trim(), ""))
            globalConfig.setOutputDir("E:\\英雄时刻\\生成代码" + "/src/main/java");
        else
            globalConfig.setOutputDir("E:\\英雄时刻\\生成代码" + "/" + moduleName + "/src/main/java");
        // 添加作者信息
...
//         自定义service生成的名字，用于删除自动生成的I前缀
    ...
    private static PackageConfig packageConfig() {
        ...
        packageConfig.setController(controllerIn);
        return packageConfig;
    }
